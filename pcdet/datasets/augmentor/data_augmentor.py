...
class DataAugmentor(object):
    ...
    def random_world_flip(self, data_dict=None, config=None):
        ...
        for cur_axis in config['ALONG_AXIS_LIST']:
            ...
            if 'points' in data_dict:
                ...
                gt_boxes, lidar_points, radar_points = getattr(augmentor_utils, 'fusion_random_flip_along_%s' % cur_axis)(
    ...
    def random_world_rotation(self, data_dict=None, config=None):
        ...
        if 'points' in data_dict:
            ...
            gt_boxes, lidar_points, radar_points = augmentor_utils.fusion_global_rotation(
    ...
    def random_world_scaling(self, data_dict=None, config=None):
        ...
        if 'points' in data_dict:
            ...
            gt_boxes, lidar_points, radar_points = augmentor_utils.fusion_global_scaling(
